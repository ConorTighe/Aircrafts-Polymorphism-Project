...
public class StuntPlane extends Aircraft {

		final int MaxPassengers = 2;
		...
		public StuntPlane(String i,String n,int p,int s, double c){
			
			setId(i).setPilot(n).setPass(p).setSpeed(s).setCost(c);
		}
		
		// Sets
		public StuntPlane setId(String i)
		{
			id = i;
			
			return this;
		}
		public StuntPlane setPilot(String n)
		{
			pilotName = n;
			
			return this;
		}
		public StuntPlane setPass(int p)
		{
			try
			{
		...
		public StuntPlane setSpeed(int s)
		{
			speed = s;
			
			return this;
		}
		public StuntPlane setCost(double c)
		{
			cost = c;
