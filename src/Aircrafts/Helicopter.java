...
public class Helicopter extends Aircraft {
		...
		public Helicopter(String i,String n,int p,int s, double c){
			
			setId(i).setPilot(n).setPass(p).setSpeed(s).setCost(c);
		}
		
		// Sets
		public Helicopter setId(String i)
		{
			id = i;
			
			return this;
		}
		public Helicopter setPilot(String n)
		{
			pilotName = n;
			
			return this;
		}
		public Helicopter setPass(int p)
		{
			try
			{
		...
		public Helicopter setSpeed(int s)
		{
			speed = s;
			
			return this;
		}
		public Helicopter setCost(double c)
		{
			cost = c;
